...
if (!class_exists('\Tablesome\Includes\Modules\Onboarding')) {
    class Onboarding
    {
        ...
        {
            $post_id = $this->table->insert_or_update_post(0, $this->get_post_data('Email Logs', 'email-logs-draft-table', 'draft'));
        ...
        public function create_sample_table()
        {
            ...
            $post_id = $this->table->insert_or_update_post(0, $this->get_post_data());
            ...
            $this->tablesome_db->insert_many($post_id, $table_meta, $table_data['records_inserted']);
        }
