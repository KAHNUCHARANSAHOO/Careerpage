...
if (!class_exists('\Tablesome\Includes\Modules\Workflow\Actions\Open_Ai_Generate_Text')) {
    class Open_Ai_Generate_Text extends Action
    {
        ...
        {
            $this->openai_api_handler = new \Tablesome\Includes\Modules\Workflow\External_Apis\OpenAI();
        }
